...
# Add /mnt/lodev_default/global-commands/web as the last item to the $PATH.
# This allows commands that weren't found elsewhere to be executed. For example, `xdebug on`
# can be used inside web container
case ":$PATH:" in
  # If the item is already in $PATH, don't add it again.
  *":/mnt/lodev_default/global-commands/web:"*) ;;
  # Otherwise, add it.
  *) PATH="$PATH:/mnt/lodev_default/global-commands/web" ;;
esac
